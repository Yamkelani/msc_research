...
'cycle_soc', ...
'cycle_dod', ...
'charge_capacity_drop_per_cycle', ...
'discharge_capacity_drop_per_cycle', ...
'cycle_charge_time', ...
...
function dataset = generate_features(features, battery_charge_data, battery_discharge_data, columns) 
    ...
    discharge_capacity = max(battery_discharge_data.Measured_cell_capacity);                  
    ...
    max_discharge_current = [max(battery_discharge_data.Measured_cell_current)];
